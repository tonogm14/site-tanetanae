...
export const MOCK_DATA = {
  ...
  hero: [
    { id: 'h1', cat: 'Indígena',  catSlug: 'indigena',          kicker: 'Warao', title: 'Comunidades warao del Bajo Delta buscan preservar sus tradiciones ancestrales', excerpt: 'Entre tambores y aguinaldos, los pueblos indígenas resisten al olvido.', img: 'indigena',          author: 'Tanetanae', date: 'Hoy, 9:42 AM', readTime: '5 min', slug: 'warao-tradiciones' },
    { id: 'h2', cat: 'Sucesos',   catSlug: 'suceso',            kicker: 'Delta Amacuro', title: 'Ciudadano cae a alcantarilla destapada en el paseo Manamo de Tucupita', excerpt: 'Vecinos exigen a la alcaldía un cronograma de reparación urgente.', img: 'suceso',            author: 'Tanetanae', date: 'Hoy, 7:15 AM', readTime: '2 min', slug: 'alcantarilla-manamo' },
    ...
    { id: 'h5', cat: 'Indígena',  catSlug: 'indigena',          kicker: 'Delta Amacuro', title: 'Saberes compartidos: delegados internacionales visitan comunidades deltanas', excerpt: 'El intercambio refuerza la visibilidad de la cultura warao.', img: 'indigena',          author: 'Tanetanae', date: 'Hoy, 6:00 AM', readTime: '4 min', slug: 'saberes-compartidos' },
  ],
  centrales: [
    { id: 'c1', cat: 'Sucesos',  catSlug: 'suceso',  title: 'Policía Delta Amacuro protege a niños en situación de calle', excerpt: 'Articulación con el gobierno regional permitió un censo casa a casa.', img: 'suceso',  date: '23 mar · 14:10', author: 'Tanetanae', slug: 'policia-ninos' },
    ...
    { id: 'c5', cat: 'Indígena', catSlug: 'indigena', title: 'Autoridades garantizan acceso a salud en comunidades del Bajo Delta', excerpt: 'Jornada médica atiende a más de 300 familias warao en el eje fluvial.', img: 'indigena', date: '20 mar · 08:00', author: 'Tanetanae', slug: 'salud-bajo-delta' },
    { id: 'c6', cat: 'Deportes', catSlug: 'deporte', title: 'Balonmano y Baloncesto 3×3 femenino clasifican a Juegos Comunales', excerpt: 'El estado aporta dos delegaciones a la fase nacional en Caracas.', img: 'deporte', date: '18 feb · 10:15', author: 'Tanetanae', slug: 'balonmano-clasifica' },
  ],
  masNoticias: [
  ...
  fueronNoticias: [
    { id: 'fn1', cat: 'Sucesos',  catSlug: 'suceso',  title: 'Hurtos de ganado vuelven a alarmar al sector pecuario en Antonio Díaz', excerpt: '', img: 'suceso',  date: '10 mar', author: 'Tanetanae', slug: 'hurtos-ganado' },
    { id: 'fn2', cat: 'Deportes', catSlug: 'deporte', title: 'Loa Tamaronis recibe a la Federación Venezolana de Taekwondo', excerpt: '', img: 'deporte', date: '8 mar',  author: 'Tanetanae', slug: 'tamaronis-taekwondo' },
    { id: 'fn3', cat: 'Indígena', catSlug: 'indigena', title: 'Comunidades del Bajo Delta participan en foro de lenguas indígenas', excerpt: '', img: 'indigena', date: '5 mar', author: 'Tanetanae', slug: 'foro-lenguas' },
  ],
  sucesos: [
    { id: 's1', cat: 'Sucesos', catSlug: 'suceso', title: 'Policía Delta Amacuro protege a niños en situación de calle en Tucupita', excerpt: 'Articulación con el gobierno regional permitió un censo casa a casa.', img: 'suceso', date: '23 mar · 14:10', author: 'Tanetanae', slug: 's1' },
  ...
  deportes: [
    ...
    { id: 'd3', cat: 'Deportes', catSlug: 'deporte', title: 'Balonmano y Baloncesto 3×3 femenino clasifican a Juegos Comunales', excerpt: 'El estado aporta dos delegaciones a la fase nacional en Caracas.', img: 'deporte', date: '18 feb · 10:15', author: 'Tanetanae', slug: 'd3' },
  ],
  indigena: [
    { id: 'i1', cat: 'Indígena', catSlug: 'indigena', title: 'Comunidades warao del Bajo Delta buscan preservar sus tradiciones', excerpt: 'Entre tambores y gaitas, los pueblos indígenas resisten al olvido.', img: 'indigena', date: '15 mar', author: 'Tanetanae', slug: 'i1' },
    { id: 'i2', cat: 'Indígena', catSlug: 'indigena', title: 'Jornada médica atiende a más de 300 familias warao en el eje fluvial', excerpt: 'Brigadas de salud llegan a las comunidades más remotas del delta.', img: 'indigena', date: '10 mar', author: 'Tanetanae', slug: 'i2' },
  ],
  trinidad: [
    { id: 'tt1', cat: 'Trinidad y Tobago', catSlug: 'trinidad-y-tobago', title: 'Delegación deltana participa en feria comercial en Puerto España', excerpt: 'Intercambio binacional refuerza lazos económicos con la isla.', img: 'trinidad-y-tobago', date: '16 mar', author: 'Tanetanae', slug: 'tt1' },
    { id: 'tt2', cat: 'Trinidad y Tobago', catSlug: 'trinidad-y-tobago', title: 'Trinidad y Tobago fortalece vínculos culturales con comunidades del Delta', excerpt: 'Festival binacional reúne a artistas de ambos lados del golfo.', img: 'trinidad-y-tobago', date: '5 mar', author: 'Tanetanae', slug: 'tt2' },
  ],
  guyana: [
    { id: 'g1', cat: 'Guyana', catSlug: 'guyana', title: 'Esequiba: Venezuela reafirma posición ante la Corte Internacional de Justicia', excerpt: 'La delegación venezolana presentó nuevas pruebas cartográficas en La Haya.', img: 'internacionales', date: '15 may', author: 'Tanetanae', slug: 'g1' },
    { id: 'g2', cat: 'Guyana', catSlug: 'guyana', title: 'Comunidades del Bajo Delta mantienen intercambio comercial con Georgetown', excerpt: '', img: 'internacionales', date: '8 may', author: 'Tanetanae', slug: 'g2' },
    { id: 'g3', cat: 'Guyana', catSlug: 'guyana', title: 'Pesca artesanal en la frontera: acuerdo local entre pescadores del río Moruca', excerpt: '', img: 'internacionales', date: '2 may', author: 'Tanetanae', slug: 'g3' },
  ],
  video: [
    ...
    { id: 'v2', cat: 'Video', catSlug: 'video', title: 'EN VIDEO: Así quedó el Paseo Manamo tras las lluvias', excerpt: 'Las imágenes muestran el nivel de inundación en el centro de Tucupita.', img: 'video', date: '12 abr', author: 'Tanetanae', slug: 'v2' },
  ],
  mostRead: [
  ...
  article: {
    ...
    author: 'Tanetanae', authorRole: 'Redacción · Tanetanae',
